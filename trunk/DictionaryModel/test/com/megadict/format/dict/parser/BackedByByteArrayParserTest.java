...
public class BackedByByteArrayParserTest {
    ...
    public void testParseValidString() {
        ...
        Index actualIndex = new BackedByByteArrayParser().parse(testIndexString);
    ...
    public void testParseInvalidString() {
        ...
        new BackedByByteArrayParser().parse(invalidFormat);
    }
    ...
    public void testParseStringWithInvalidBase64Encoding() {
        ...
        new BackedByByteArrayParser().parse(invalidString);
    }
